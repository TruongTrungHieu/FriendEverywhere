 ...
 */
public class DeleteAccountAsyncTask extends AsyncTask<String, Void, JSONObject> {
    ...
    public DeleteAccountAsyncTask setCallback(Callback callback) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try {
            String result = NetworkSupport.sendRequest(Constants.URL_DELETE_ACCOUNT, listParams, NetworkSupport.RequestMethod.POST, 50000);
