...
import com.fithou.friendeverywhere.ultis.appintro.CirclePageIndicator;
import com.fithou.friendeverywhere.ultis.appintro.ColorShades;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSkip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent main = new Intent(AppIntroActivity.this, MainActivity.class);
                startActivity(main);
            }
        });
