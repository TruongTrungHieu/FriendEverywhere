...
public class GetListFriendAsyncTask extends AsyncTask<String, Void, ArrayList<FriendObject>> {

    private Callback<ArrayList<FriendObject>> callback;
    private Context context;

    public GetListFriendAsyncTask setCallback(Callback callback) {
        this.callback = callback;
        return this;
    }

    public GetListFriendAsyncTask(Context context) {
    ...
    protected ArrayList<FriendObject> doInBackground(String... params) {
        ...
        try {
            String result = NetworkSupport.sendRequest(Constants.URL_GET_LIST_FRIEND, listParams, NetworkSupport.RequestMethod.POST, 50000);
