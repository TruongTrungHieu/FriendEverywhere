...
public class FindFriendAsyncTask extends AsyncTask<String, Void, JSONObject> {

    private Callback callback;
    private Context context;

    public FindFriendAsyncTask setCallback(Callback callback) {
        this.callback = callback;
        return this;
    }

    public FindFriendAsyncTask(Context context) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        listParams.add(new BasicNameValuePair("user_id", params[1]));
        try {
            String result = NetworkSupport.sendRequest(Constants.URL_FIND_FRIEND, listParams, NetworkSupport.RequestMethod.POST, 50000);
