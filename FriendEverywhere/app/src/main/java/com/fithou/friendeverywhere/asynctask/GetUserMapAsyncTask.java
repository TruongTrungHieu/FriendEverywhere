...
public class GetUserMapAsyncTask extends AsyncTask<String, Void, ArrayList<FriendObject>> {

    private Callback<ArrayList<FriendObject>> callback;
    private Context context;

    public GetUserMapAsyncTask setCallback(Callback callback) {
        this.callback = callback;
        return this;
    }

    public GetUserMapAsyncTask(Context context) {
    ...
    protected ArrayList<FriendObject> doInBackground(String... params) {
        ...
        try {
            String result = NetworkSupport.sendRequest(Constants.URL_GET_USER_MAP, listParams, NetworkSupport.RequestMethod.POST, 50000);
